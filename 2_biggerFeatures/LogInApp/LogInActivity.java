...
public class LogInActivity extends AppCompatActivity implements View.OnKeyListener, View.OnClickListener {
    ...
    protected void changeLogInMode(View view){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("com.basti.loginapp", Context.MODE_PRIVATE);
        ...
        RelativeLayout relativeLayout = (RelativeLayout) findViewById(R.id.activity_log_in);
        ...
        RelativeLayout relativeLayoutBackground = (RelativeLayout) findViewById(R.id.relative_layout_picture);

        relativeLayout.setOnClickListener(this);
        relativeLayoutBackground.setOnClickListener(this);
